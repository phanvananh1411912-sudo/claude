...
-- FILE TỔNG HỢP (MERGED): gộp toàn bộ nội dung từ full_289_scenes_final.sql,
-- full_324_scenes_final.sql, full_349_scenes_final.sql và full_379_scenes_final.sql.
-- full_379_scenes_final.sql là tập hợp đầy đủ nhất (379 situations, cumulative
-- superset of 289/324/349 across every table), nên nội dung ở đây tương đương.
-- Mọi INSERT đều có ON CONFLICT DO NOTHING nên có thể chạy đè an toàn lên DB
-- đã có dữ liệu từ các phiên bản trước.
-- ============================================================
