...
lessons = json.load(open(f'{SP}/parsed_hsk3ht.json', encoding='utf-8'))['hsk3ht']

enr = {}
for f in glob.glob(f'{SP}/enriched/sent_hsk3ht_*.out.json'):
...
out = f'{SP}/HSK4NEXUS-HSK3-HoiThoai-6bai.xlsx'
