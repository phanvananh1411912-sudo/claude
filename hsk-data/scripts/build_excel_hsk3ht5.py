...
for f in glob.glob(f'{SP}/enriched/sent_hsk3ht5_*.out.json'):
...
lessons = json.load(open(f'{SP}/parsed_hsk3ht5.json', encoding='utf-8'))['hsk3ht5']
...
out = f'{SP}/HSK4NEXUS-HSK3-HoiThoai-Bai23-40.xlsx'
